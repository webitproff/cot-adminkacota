...
<!-- END: WARNING -->
<!-- BEGIN: DONE -->
<div class="uk-card uk-border-rounded border-lime uk-card-small uk-alert-success my-3" uk-alert>
  <a class="uk-alert-close text-navy" uk-close></a>
  <div class="uk-card-header">
    <div class="uk-grid-small uk-flex-middle" uk-grid>
      <div class="uk-width-auto">
      ...
      <div class="uk-width-expand">
        <h3 class="uk-card-title text-navy uk-margin-remove-bottom">{PHP.L.Done}</h3>
      </div>
    </div>
  </div>
  <div class="uk-card-body">
