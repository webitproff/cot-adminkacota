          ...
          <div class="row">
            <div class="col-md-6 col-sm-10 d-flex align-items-center">
              <h3 class="card-title d-flex align-items-center">
                ...
                <span class="badge bg-danger color-palette flex-grow-1 ms-3 text-uppercase p-1">{PHP.L.Configuration}:</span><span>{PHP.adminpath.2.1}</span>
              </h3>
            </div>
        ...
        <div class="card-body">
            ...
            <form name="saveconfig" id="saveconfig" action="{ADMIN_CONFIG_FORM_URL}" method="post" class="ajax form-horizontal">
                    ...
                    <table class="table table-hover table-striped">
						...
						<div class="row g-3 mb-3">
						  <div class="col-md-4 col-sm-12"><p class="h5">  {ADMIN_CONFIG_ROW_CONFIG_TITLE}: </p></div>
						  <div class="col-md-6 col-sm-12">
							<div class="">{ADMIN_CONFIG_ROW_CONFIG}</div>
							<div class="mt-1"><small class="text-muted">{ADMIN_CONFIG_ROW_CONFIG_MORE}</small></div>
						  </div>
						  <div class="col-md-2 col-sm-12">
							<div class="btn-group">
            ...
            <ul class="list-group list-group-flush">
              ...
              <li class="list-group-item">
                <a href="{ADMIN_CONFIG_ROW_URL}" class="ajax d-flex align-items-center" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="{ADMIN_CONFIG_ROW_DESC}">
                  ...
                  <!-- ELSE -->
                  <img src="{PHP.cfg.system_dir}/admin/img/plugins32.png" class="flex-shrink-0" />
                  <!-- ENDIF -->
                  <span class="flex-grow-1 ms-3 text-uppercase p-1">
