...
<div class="uk-margin uk-margin-top uk-card uk-card-default uk-padding-small uk-width-expand uk-border-rounded uk-box-shadow" uk-height-viewport="expand: true">
  <h2>
    <span class="uk-h3 uk-text-bold uk-link-text">{PHP.L.Pages} ({ADMIN_PAGE_TOTALDBPAGES})</span>
  </h2> {FILE "{PHP.cfg.themes_dir}/{PHP.theme}/warnings.tpl"} <div class="uk-grid-small uk-child-width-1-2@m uk-child-width-1-4@l" uk-grid>
    <div>
      <a uk-tooltip="{PHP.L.Configuration}" class="uk-link-text" href="{ADMIN_PAGE_URL_CONFIG}">
        <div class="uk-tile uk-background-muted uk-padding-small uk-width-1-1 uk-box-shadow-medium uk-margin-small-bottom uk-border-rounded">
          <div class="uk-flex uk-flex-middle uk-flex-left uk-flex-center@s">
            <img src="{PHP.cfg.mainurl}/themes/admin/adminkacota/img/config.svg" title="" class=" uk-margin-small-right" width="38" height="38">
    ...
    <div>
      <a uk-tooltip="{PHP.L.adm_extrafields_desc}" class="uk-link-text" href="{ADMIN_PAGE_URL_EXTRAFIELDS}">
        <div class="uk-tile uk-background-muted uk-padding-small uk-width-1-1 uk-box-shadow-medium uk-margin-small-bottom uk-border-rounded">
          <div class="uk-flex uk-flex-middle uk-flex-left uk-flex-center@s">
            <img src="{PHP.cfg.mainurl}/themes/admin/adminkacota/img/extrafields.svg" title="" class=" uk-margin-small-right" width="38" height="38">
    ...
    <div>
      <a uk-tooltip="" class="uk-link-text" href="{ADMIN_PAGE_URL_STRUCTURE}">
        <div class="uk-tile uk-background-muted uk-padding-small uk-width-1-1 uk-box-shadow-medium uk-margin-small-bottom uk-border-rounded">
          <div class="uk-flex uk-flex-middle uk-flex-left uk-flex-center@s">
            <img src="{PHP.cfg.mainurl}/themes/admin/adminkacota/img/structure.svg" title="" class=" uk-margin-small-right" width="38" height="38">
    ...
    <div>
      <a uk-tooltip="" class="uk-link-text" href="{ADMIN_PAGE_URL_ADD}">
        <div class="uk-tile uk-background-muted uk-padding-small uk-width-1-1 uk-box-shadow-medium uk-margin-small-bottom uk-border-rounded">
          <div class="uk-flex uk-flex-middle uk-flex-left uk-flex-center@s">
            <img src="{PHP.cfg.mainurl}/themes/admin/adminkacota/img/pages.svg" title="" class=" uk-margin-small-right" width="38" height="38">
  ...
  <h3>
    <span class="uk-text-medium uk-text-bold uk-text-capitalize">{PHP.L.Pages}:</span>
  </h3>
  <form id="form_valqueue" name="form_valqueue" method="post" action="{ADMIN_PAGE_FORM_URL}">
    <div class="uk-grid-small" uk-grid>
      ...
      <div class="uk-width-expand@l">
        <div class="uk-margin">
          <label class="uk-form-label">
            <span uk-tooltip="" class="uk-h4 uk-text-warning">{PHP.L.adm_sort}</span>
          </label>
          <div class="uk-form-controls">
            <div class="uk-grid-small" uk-grid>
              <div class="uk-width-1-2@m"> {ADMIN_PAGE_ORDER} </div>
              <div class="uk-width-1-2@m"> {ADMIN_PAGE_WAY} </div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="uk-width-1-3@l">
        <div class="uk-margin">
          <label class="uk-form-label">
            <span uk-tooltip="" class="uk-h4 uk-text-warning">{PHP.L.Show}</span>
          </label>
          <div class="uk-form-controls"> {ADMIN_PAGE_FILTER} </div>
        </div>
      </div>
    ...
    <div class="uk-margin">
      <label class="uk-form-label">
        <span uk-tooltip="" class="uk-h4 uk-text-warning">{PHP.L.All}</span>
      </label>
      <div class="uk-form-controls">
            ...
            <div class="uk-grid-small" uk-grid>
              ...
              <div class="uk-width-expand@m {ADMIN_PAGE_ODDEVEN}">
                <ul uk-accordion="multiple: false">
                  <li>
                    <a class="uk-accordion-title uk-link-text" href="#mor_{PHP.ii}">
                      <span uk-tooltip="{PHP.L.Title}" class="uk-h4">{ADMIN_PAGE_SHORTTITLE}</span>
                    </a>
    ...
    <nav>
      <ul class="uk-pagination uk-flex-center uk-margin-top uk-margin-bottom">{ADMIN_PAGE_PAGINATION_PREV}{ADMIN_PAGE_PAGNAV}{ADMIN_PAGE_PAGINATION_NEXT}</ul>
    </nav>
    <p class="paging">
